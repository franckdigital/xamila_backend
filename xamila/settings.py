...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,testserver,api.xamila.finance,xamila.finance,www.xamila.finance', cast=lambda v: [s.strip() for s in v.split(',')])
