...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,testserver,api.xamila.finance,xamila.finance,www.xamila.finance,srv958363', cast=lambda v: [s.strip() for s in v.split(',')])
...
# SQLite configuration (commented out due to JSONField incompatibility)
# DATABASES = {
#     'default': {
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'franckalain.digital@gmail.com')
XAMILA_TEAM_EMAIL = 'xamila.developer@gmail.com'
EMAIL_HOST = os.getenv('EMAIL_HOST', 'smtp.gmail.com')
EMAIL_PORT = int(os.getenv('EMAIL_PORT', '587'))
EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'True').lower() == 'true'
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'franckalain.digital@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'vrzh neej gywy kuva')
